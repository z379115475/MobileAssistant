...
// 选择通信协议
#define SEL_PROTOCOL	HTTP_PROTOCOL
...
public:
	...
	BOOL PostReq(LPCTSTR strUrl, LPCTSTR strBody, CString& strRetData, LPCTSTR strHost = TONGJI_URL)
	{
	...
	BOOL GetReq(LPCTSTR strHost, LPCTSTR strUrl, CString& strRetData)
	{
